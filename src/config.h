...
#define CONFIG_API_HISTORY_MAX 30
#define CONFIG_API_SOURCES_MAX 30
#define CONFIG_API_BATCH_SIZE 50
#define CONFIG_HISTORY_MAX CONFIG_API_HISTORY_MAX
#define CONFIG_SOURCES_MAX CONFIG_API_SOURCES_MAX
